"""Deploy only an accepted, unmodified source from the completed thinking comparison."""
...
r = load('thinking_runner', HERE/'runner.py')
...
def verify_live(run):
    ...
    if (protocol.get('mode')!='live' or protocol.get('id')!='amr-thinking-diagnostic/v1'
        ...
        raise ValueError('unexpected thinking comparison configuration')
